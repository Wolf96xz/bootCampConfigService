...
public class Customer implements Serializable {
	 ...
	 * @return the surName1
	 */
	@Column(name = "C_SURNAME1", nullable = false)
	 ...
	 * @return the surName2
	 */
	@Column(name = "C_SURNAME2", nullable = false)
	 ...
	 */
	@Column(name = "C_DOC_NUMBER", nullable = false, unique = true)
	...
	public String toString() {
		...
		return "Customer [id=" + id + ", name=" + name + ", surName1=" + surName1 + ", surName2=" + surName2 + ", identityDocNumber=" + identityDocNumber + "]";
	}
